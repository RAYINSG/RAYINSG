...
const styles = StyleSheet.create({
  ...
  statusCard: { paddingVertical: Spacing.lg },
  expiredCard: { backgroundColor: Colors.expired },
  soonCard: { backgroundColor: Colors.expiringSoon },
  expiryLabel: { fontSize: FontSize.xl, fontWeight: '700', color: Colors.text, textAlign: 'center' },
  expiryDate: { fontSize: FontSize.sm, color: Colors.textSecondary, marginTop: Spacing.xs, textAlign: 'center' },
